...
if (isset($_POST['actionType'])) {
  switch ($_POST['actionType']) {
    case "Add":
      ...
      break;
     case "Edit":
      if (updatePlayer($_POST['tID'], $_POST['pName'], $_POST['pPosition'], $_POST['pReceptions'], $_POST['pReceptionYards'], $_POST['pReceptionTargets'], $_POST['pRushingAttempts'], $_POST['pRushingYards'], $_POST['pRushingYardsPerAttempt'], $_POST['pID'], $_POST['tName'])) {
